...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2021 at 10:02 PM
...
(5, '2021_08_24_190241_create_sql_models_table', 1);
...
--
-- Table structure for table `sql_models`
--
...
--
-- Indexes for table `sql_models`
--
ALTER TABLE `sql_models`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `sql_models`
--
ALTER TABLE `sql_models`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
